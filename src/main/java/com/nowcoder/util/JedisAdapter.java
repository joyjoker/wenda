...
public class JedisAdapter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        pool = new JedisPool("redis://192.168.111.128:6379/10");
    }
    ...
    //to familiar jedis API
    public static void print(int index, Object object) {
        System.out.println(String.format("%d %s", index, object.toString()));
    }

    public static void main(String[] args) {
        Jedis jedis = new Jedis("redis://192.168.111.128:6379/9");
        jedis.flushDB();
        //get and set
        ...
        print(25, jedis.sismember(likeKey1, "9"));
        print(26, jedis.sismember(likeKey2, "16"));
        jedis.srem(likeKey1, "5"); //set remove member
